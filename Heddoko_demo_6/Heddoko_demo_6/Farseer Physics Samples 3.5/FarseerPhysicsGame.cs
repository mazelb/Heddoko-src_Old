...
namespace FarseerPhysics.Samples
{
    ...
    public class FarseerPhysicsGame : Game
    {
        ...
        {
            Window.Title = "Heddoko Movement Detection";
        ...
        protected override void Initialize()
        {
            ...
            Heddoko_Demo1 simple1 = new Heddoko_Demo1();
            ...
            MenuScreen menuScreen = new MenuScreen("Heddoko Samples");

            menuScreen.AddMenuItem("Proof of Concept", EntryType.Separator, null);
