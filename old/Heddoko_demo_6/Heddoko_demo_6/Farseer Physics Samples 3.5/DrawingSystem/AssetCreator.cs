...
namespace FarseerPhysics.Samples.DrawingSystem
{
    ...
    public class AssetCreator
    {
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            _materials[MaterialType.arm_base] = contentManager.Load<Texture2D>("Arm/robot_arm_base");
            _materials[MaterialType.arm] = contentManager.Load<Texture2D>("Arm/robot_arm_arm");
        }
