...
void loop() 
{
  ...
  {  
    for(int i=0; i < 10; i++) 
    {
      ...
      if (i==2) {
        ...
        bluetooth.println("~~LEFT ARM ACCEL 1~~");
      }
      if (i==5) {
        Serial.println("~~LEFT ARM ACCEL 2~~");
        bluetooth.println("~~LEFT ARM ACCEL 2~~");
      }
      if (i==8) {
        Serial.println("~~LEFT ARM ACCEL 3~~");
        bluetooth.println("~~LEFT ARM ACCEL 3~~");
      }
      if (i==9) {
        Serial.println("~~LEFT ARM BEND~~");
        bluetooth.println("~~LEFT ARM BEND~~");
      }
    }
  ...
  if(Serial2.available())
  {
    for(int i=0; i < 10; i++) 
    {
      ...
      if (i==2) {
        Serial.println("~~RIGHT ARM ACCEL 1~~");
        bluetooth.println("~~RIGHT ARM ACCEL 1~~");
      }
      
      if (i==5) {
        Serial.println("~~RIGHT ARM ACCEL 2~~");
        bluetooth.println("~~RIGHT ARM ACCEL 2~~");
      }
      
      if (i==8) {
        Serial.println("~~RIGHT ARM ACCEL 3~~");
        bluetooth.println("~~RIGHT ARM ACCEL 3~~");
      }
      if (i==9) {
      Serial.println("~~RIGHT ARM BEND~~");
      bluetooth.println("~~RIGHT ARM BEND~~");
      }      
    }
  ...
  if(Serial3.available())
  {
    for(int i=0; i < 9; i++) 
    {
      ...
      if (i==2) {
          Serial.println("~~TORSO IMU 1~~");
          bluetooth.println("~~TORSO IMU 1~~");
      }
      
      if (i==5) {
          Serial.println("~~TORSO IMU 2~~");
          bluetooth.println("~~TORSO IMU 2~~");
      }
      if (i==8) {
          Serial.println("~~TORSO IMU 3~~");
          bluetooth.println("~~TORSO IMU 3~~");
          }        
    }  
