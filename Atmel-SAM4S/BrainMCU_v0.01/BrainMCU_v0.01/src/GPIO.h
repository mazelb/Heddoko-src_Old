...
#define PIN_SW0_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P2)

/*	Power button	*/
#define PIN_PW_SW_GPIO  (PIO_PA0_IDX)
#define PIN_PW_SW_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P0)

/*	Action Switch 1	*/
#define PIN_AC_SW1_GPIO  (PIO_PA1_IDX)
#define PIN_AC_SW1_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P1)

/*	Action Switch 2	*/
#define PIN_AC_SW2_GPIO  (PIO_PA20_IDX)
#define PIN_AC_SW2_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P20)

/*	Jack OC 1	*/
#define PIN_JC_OC1_GPIO  (PIO_PA16_IDX)
#define PIN_JC_OC1_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P16)

/*	Jack OC 2	*/
#define PIN_JC_OC2_GPIO  (PIO_PA15_IDX)
#define PIN_JC_OC2_FLAGS (PIO_IT_RISE_EDGE | PIO_TYPE_PIO_INPUT | PIO_PER_P15)
