...
static void app_menu_handler_gatt_ext_evt_notif(void) {
		...
		case '1':
			...
			app_gatt_write_char_req(GATT_WRITE_CHAR,0,0x0043,2,(uint8_t *)input_d);	
			break;
		case '2':
			...
			break;
		case '3':
			app_gatt_read_char_req(GATT_READ_CHAR,0,0x0043);
			break;
		 case 'r':
 ...
 * GATT menu handler for read, write (req is no diff than command so use req),
